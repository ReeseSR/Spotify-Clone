...
final class PlayerControlsView: UIView {
    ...
    @objc private func didTapNext() {
        delegate?.playerControlsViewDidTapPlayFowardButton(<#T##playerControlsView: PlayerControlsView##PlayerControlsView#>)
    }
    @objc private func didTapPlayPause() {
        delegate?.playerControlsViewDidTapPlayPauseButton(<#T##playerControlsView: PlayerControlsView##PlayerControlsView#>)
    }
