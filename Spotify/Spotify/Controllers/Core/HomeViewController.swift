...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        configureCollectionView()   // 스크롤 시 헤더 같이 움직이게 하기 위해서는 collection View 먼저
    ...
    private func configureModels(
        ...
        sections.append(.newReleases(viewModels: newAlbums.compactMap({
            return NewReleasesCellViewModel(name: $0.name,
                                            artworkURL: URL(string: $0.images.first?.url ?? ""), numberOfTracks: $0.total_tracks,
    ...
    static func createSectionLayout(section: Int) -> NSCollectionLayoutSection {
        ...
        case 0:
            ...
            let verticalGroup = NSCollectionLayoutGroup.vertical(
                layoutSize: NSCollectionLayoutSize(
                    widthDimension: .fractionalWidth(1.0),
                    heightDimension: .absolute(390)),   // each of the vertically stacked items has a space of 120
                subitem: item,
                count: 3
            )
            ...
            let horizontalGroup = NSCollectionLayoutGroup.horizontal(
                layoutSize: NSCollectionLayoutSize(
                    widthDimension: .fractionalWidth(0.9),  // bleed over 10% of the next group
